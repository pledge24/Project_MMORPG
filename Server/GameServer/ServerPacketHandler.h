...
public:
	...
	static SendBufferRef MakeSerializedPacket(Protocol::S_ENTER_MAP& pkt) { return MakeSerializedPacket(pkt, PKT_S_ENTER_MAP); }
	static SendBufferRef MakeSerializedPacket(Protocol::S_ENTER_ROOM& pkt) { return MakeSerializedPacket(pkt, PKT_S_ENTER_ROOM); }
