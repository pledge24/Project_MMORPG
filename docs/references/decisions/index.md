...
이 폴더는 프로젝트의 **결정 로그**다. 코드를 읽어도 알 수 없는 제약과 그 근거만 남긴다.
...
|---|---|---|---|---|
| [0000](0000-superseded-harness-verdict.md) | 하네스 판정표 (초안) | build | superseded | ADR-0001이 대체. 소스 4개 기반 초기 판정 |
...
```bash
cp .claude/skills/new-adr/assets/adr-template.md docs/decisions/000N-title-with-dashes.md
```
